      ...
      <ScrollView >
        ...
        <View style={{
          ...
          <TouchableOpacity style={{
            ...
            <Card style={{
                backgroundColor: '#CA5C0A'
              }}>
              <Image source={{
                  uri: 'http://cerveceriaallende.mx/wp-content/uploads/2016/02/GoldenAleFinal2.png'
                }} style={{
                  height: 200,
                  width: null
                }}/>
        ...
        <View style={{
          ...
          <TouchableOpacity style={{
            ...
            <Card style={{
              ...
              <Image source={{
                  uri: 'http://cerveceriaallende.mx/wp-content/uploads/2014/08/AgaveFinal2.png'
                }} style={{
                  height: 200,
                  width: null
                }}></Image>
          ...
          <TouchableOpacity style={{
            ...
            <Card style={{
                backgroundColor: '#BA3812'
              }}>
              <Image source={{
                  uri: 'http://cerveceriaallende.mx/wp-content/uploads/2016/02/IpaFinal2.png'
                }} style={{
                  height: 200,
                  width: null
                }}></Image>
